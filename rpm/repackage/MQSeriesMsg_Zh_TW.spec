Summary: IBM MQ Messages (Traditional Chinese) FileSet
Name: MQSeriesMsg_Zh_TW
Version: 9.0.0
Release: 0
License: Commercial
...
5724-H72 
This package provides the IBM MQ message catalog for the
...
install -d $RPM_BUILD_ROOT/opt/mqm/msg/zh_TW
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_Messages_Chinese_Traditional-9.0.0.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_Messages_Chinese_Traditional-9.0.0.mqtag
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/msg/zh_TW/amq.cat $RPM_BUILD_ROOT/opt/mqm/msg/zh_TW/amq.cat

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg/zh_TW"
%attr(444,mqm,mqm) "/opt/mqm/swidtag/IBM_MQ_Messages_Chinese_Traditional-9.0.0.mqtag"
%attr(444,mqm,mqm) "/opt/mqm/msg/zh_TW/amq.cat"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ Messages (Traditional Chinese) FileSet"
RPM_PACKAGE_NAME="MQSeriesMsg_Zh_TW"
