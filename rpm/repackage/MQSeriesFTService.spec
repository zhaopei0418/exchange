Summary: IBM MQ Managed File Transfer Service
Name: MQSeriesFTService
Version: 9.0.0
Release: 0
License: Commercial
...
Requires: MQSeriesFTAgent = 9.0.0-0
...
5724-H72 
This package provides the IBM MQ Managed File Transfer Service file
transfer agent capabilities, which includes the protocol bridge agent (to
connect to a FTP, FTPS and SFTP server), as well as the Web Gateway feature.
%clean
...
install -d $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge
install -d $RPM_BUILD_ROOT/opt/mqm/mqft/samples/schema
install -d $RPM_BUILD_ROOT/opt/mqm/mqft/web
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/protocolBridge/SampleCredentialExit.java $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SampleCredentialExit.java
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit.java $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit.java
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit2.java $RPM_BUILD_ROOT/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit2.java
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/mqft/samples/credentials/ProtocolBridgeCredentials.xml $RPM_BUILD_ROOT/opt/mqm/mqft/samples/credentials/ProtocolBridgeCredentials.xml
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/mqft/lib/agenttype.properties $RPM_BUILD_ROOT/opt/mqm/mqft/lib/agenttype.properties
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/fteCreateBridgeAgent $RPM_BUILD_ROOT/opt/mqm/bin/fteCreateBridgeAgent
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/fteSetAgentLogLevel $RPM_BUILD_ROOT/opt/mqm/bin/fteSetAgentLogLevel
...
%dir %attr(555,bin,bin) "/opt/mqm/mqft/samples/protocolBridge"
%dir %attr(555,bin,bin) "/opt/mqm/mqft/samples/schema"
%dir %attr(555,bin,bin) "/opt/mqm/mqft/web"
%attr(444,bin,bin) "/opt/mqm/mqft/samples/protocolBridge/SampleCredentialExit.java"
%attr(444,bin,bin) "/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit.java"
%attr(444,bin,bin) "/opt/mqm/mqft/samples/protocolBridge/SamplePropertiesExit2.java"
%attr(444,bin,bin) "/opt/mqm/mqft/samples/credentials/ProtocolBridgeCredentials.xml"
%attr(444,bin,bin) "/opt/mqm/mqft/lib/agenttype.properties"
%attr(555,mqm,mqm) "/opt/mqm/bin/fteCreateBridgeAgent"
%attr(555,mqm,mqm) "/opt/mqm/bin/fteSetAgentLogLevel"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ Managed File Transfer Service"
RPM_PACKAGE_NAME="MQSeriesFTService"
