Summary: IBM MQ Messages (Italian) FileSet
Name: MQSeriesMsg_it
Version: 9.0.0
Release: 0
License: Commercial
...
5724-H72 
This package provides the IBM MQ message catalog for the Italian
language.
%clean
...
install -d $RPM_BUILD_ROOT/opt/mqm/msg/it_IT
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_Messages_Italian-9.0.0.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_Messages_Italian-9.0.0.mqtag
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/msg/it_IT/amq.cat $RPM_BUILD_ROOT/opt/mqm/msg/it_IT/amq.cat

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg/it_IT"
%attr(444,mqm,mqm) "/opt/mqm/swidtag/IBM_MQ_Messages_Italian-9.0.0.mqtag"
%attr(444,mqm,mqm) "/opt/mqm/msg/it_IT/amq.cat"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ Messages (Italian) FileSet"
RPM_PACKAGE_NAME="MQSeriesMsg_it"
