Summary: IBM MQ Messages (French) FileSet
Name: MQSeriesMsg_fr
Version: 9.0.0
Release: 0
License: Commercial
...
5724-H72 
This package provides the IBM MQ message catalog for the French language.
%clean
...
install -d $RPM_BUILD_ROOT/opt/mqm/msg/fr_FR
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_Messages_French-9.0.0.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_Messages_French-9.0.0.mqtag
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/msg/fr_FR/amq.cat $RPM_BUILD_ROOT/opt/mqm/msg/fr_FR/amq.cat

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg/fr_FR"
%attr(444,mqm,mqm) "/opt/mqm/swidtag/IBM_MQ_Messages_French-9.0.0.mqtag"
%attr(444,mqm,mqm) "/opt/mqm/msg/fr_FR/amq.cat"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ Messages (French) FileSet"
RPM_PACKAGE_NAME="MQSeriesMsg_fr"
