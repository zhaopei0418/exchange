...
5724-H72 
This package provides the IBM Global Security Kit for use with the security and encryption technology
within IBM MQ.
%clean
...
install -d $RPM_BUILD_ROOT/opt/mqm/gskit8
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_GSKit-8.0.50.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_GSKit-8.0.50.mqtag
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/strmqikm $RPM_BUILD_ROOT/opt/mqm/bin/strmqikm
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/runmqakm $RPM_BUILD_ROOT/opt/mqm/bin/runmqakm
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/runmqckm $RPM_BUILD_ROOT/opt/mqm/bin/runmqckm
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/amqcgskv32 $RPM_BUILD_ROOT/opt/mqm/bin/amqcgskv32
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/amqcgskv64 $RPM_BUILD_ROOT/opt/mqm/bin/amqcgskv64
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/bin/amqigski $RPM_BUILD_ROOT/opt/mqm/bin/amqigski
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/gskit8/gskssl32.tar.gz $RPM_BUILD_ROOT/opt/mqm/gskit8/gskssl32.tar.gz
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/gskit8/gskssl64.tar.gz $RPM_BUILD_ROOT/opt/mqm/gskit8/gskssl64.tar.gz

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/bin"
%dir %attr(555,mqm,mqm) "/opt/mqm/gskit8"
%attr(444,mqm,mqm) "/opt/mqm/swidtag/IBM_MQ_GSKit-8.0.50.mqtag"
%attr(555,mqm,mqm) "/opt/mqm/bin/strmqikm"
%attr(555,mqm,mqm) "/opt/mqm/bin/runmqakm"
%attr(555,mqm,mqm) "/opt/mqm/bin/runmqckm"
%attr(555,mqm,mqm) %verify(not md5 mtime) "/opt/mqm/bin/amqcgskv32"
%attr(555,mqm,mqm) %verify(not md5 mtime) "/opt/mqm/bin/amqcgskv64"
%attr(555,mqm,mqm) "/opt/mqm/bin/amqigski"
%attr(444,mqm,mqm) "/opt/mqm/gskit8/gskssl32.tar.gz"
%attr(444,mqm,mqm) "/opt/mqm/gskit8/gskssl64.tar.gz"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ GSKit FileSet"
RPM_PACKAGE_NAME="MQSeriesGSKit"
...
## @(#) MQMBID sn=p900-L160520.DE su=_6zq1EB58Eearh6Qyg9d9Dg pn=install/unix/linux_2/gskit_postinstall.sh
##   <copyright 
##   notice="lm-source-program" 
##   pids="5724-H72" 
##   years="2010,2014" 
...
##
TARFLAGS='-xzf'
MQ_RUNSCRIPT="/bin/bash"
echo ${SHELLOPTS} | grep xtrace > /dev/null
if [ $? -eq 0 ] ; then
  TARFLAGS='-xvzf'
  MQ_RUNSCRIPT="/bin/bash -x"
fi
...
#
#####################################################################################
${MQ_RUNSCRIPT} ${MQ_INSTALLATION_PATH}/bin/amqigski -i
if [ $? -ne 0 ] ; then 
  exitval=2
  echo "WARNING:   GSKit Postinstall failed - see previous messages" >&2
fi
...
## @(#) MQMBID sn=p900-L160520.DE su=_6zq1EB58Eearh6Qyg9d9Dg pn=install/unix/linux_2/gskit_preuninstall.sh
##   <copyright 
##   notice="lm-source-program" 
##   pids="5724-H72" 
##   years="2010,2014" 
...
#
#####################################################################################
${MQ_RUNSCRIPT} ${MQ_INSTALLATION_PATH}/bin/amqigski -r
if [ $? -ne 0 ] ; then 
  echo "WARNING:   GSKit preuninstall failed - see previous messages" >&2
fi
