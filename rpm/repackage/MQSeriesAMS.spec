Summary: IBM MQ Advanced Message Security
Name: MQSeriesAMS
Version: 9.0.0
Release: 0
License: Commercial
...
Advanced Message Security capability.
%clean
...
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/lib/smqcert.lic $RPM_BUILD_ROOT/opt/mqm/lib/smqcert.lic

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/lib"
%attr(444,mqm,mqm) "/opt/mqm/lib/smqcert.lic"
