Summary: IBM MQ Messages (Japanese) FileSet
Name: MQSeriesMsg_ja
Version: 9.0.0
Release: 0
License: Commercial
...
5724-H72 
This package provides the IBM MQ message catalog for the Japanese
language.
%clean
...
install -d $RPM_BUILD_ROOT/opt/mqm/msg/ja_JP
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/swidtag/IBM_MQ_Messages_Japanese-9.0.0.mqtag $RPM_BUILD_ROOT/opt/mqm/swidtag/IBM_MQ_Messages_Japanese-9.0.0.mqtag
install /build/slot2/p900_P/obj/amd64_linux_2/ship/opt/mqm/msg/ja_JP/amq.cat $RPM_BUILD_ROOT/opt/mqm/msg/ja_JP/amq.cat

%files
%dir %attr(555,mqm,mqm) "/opt/mqm"
%dir %attr(555,mqm,mqm) "/opt/mqm/swidtag"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg"
%dir %attr(555,mqm,mqm) "/opt/mqm/msg/ja_JP"
%attr(444,mqm,mqm) "/opt/mqm/swidtag/IBM_MQ_Messages_Japanese-9.0.0.mqtag"
%attr(444,mqm,mqm) "/opt/mqm/msg/ja_JP/amq.cat"

%pre
RPM_PACKAGE_SUMMARY="IBM MQ Messages (Japanese) FileSet"
RPM_PACKAGE_NAME="MQSeriesMsg_ja"
